...
if (!$db) {
    echo "<h2 style='color:red;text-align:center;margin-top:40vh;'>❌ Database tidak dapat terhubung.<br>Periksa config.php.</h2>";
    exit;
}
...
<body>
  <div class="w-full max-w-sm p-8 rounded-2xl shadow-2xl card text-center text-gray-100">
    ...
    <p class="text-center text-gray-400 text-xs mt-6">© 2025 TakeOff IPTV • Powered by OgieTV</p>
  </div>
</body>
</html>